...
function updatePreview(){
    ...
    if (reasonLower.includes("sick") || reasonLower.includes("ill")) {
        ...
        reasonSentence = `I have personal work and will be unable to attend school on ${date}.`;
    } else {
...
Respected Sir/Madam,  
I am ${name}    a student of class ${cls}  stream ${stream}   Roll No ${roll}. ${reasonSentence}  

Kindly grant me leave for the mentioned date. I will ensure to catch up with the missed lessons.  
...
document.querySelectorAll('#application_for_leave input, #application_for_leave textarea, #application_for_leave select').forEach(el => {
